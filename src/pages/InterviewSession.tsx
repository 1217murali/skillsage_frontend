      ...
      <div className={`transition-all duration-500 ease-in-out ${isInterviewActive ? 'w-full lg:w-1/3 xl:w-1/4' : 'w-full lg:w-1/3 xl:w-1/4'} bg-gray-900 border-l border-gray-700 p-6 flex flex-col shadow-inner`}>
        {!isInterviewActive ? (
          ...
          >
            ...
            <Button
              onClick={() => navigate('/p2p-interview')}
              className="w-full max-w-xs py-3 text-lg font-semibold rounded-lg shadow-md hover:shadow-lg transition-all duration-300 mt-4 border border-blue-500/30"
              variant="outline"
            >
